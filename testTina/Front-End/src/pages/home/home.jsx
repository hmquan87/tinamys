...
const Home = () => {
    ...
    const [click, setClick] = useState('/page');
    const handleClick = (path) => {
        setClick(path);
        setDirect('none');
    }
    const [direct, setDirect] = useState('click');
        ...
        <div className="home">
            ...
            <div className="body-home">
                <div className={`body-home-left ${check ? '' : 'summary'}`}>
                    <div className="btn-body-home-left ">
                        <button onClick={handleClick1} className="flex justify-center items-center shadow-lg">
                ...
                <div className="body-home-right">
                    {click === '/page' && <Clone />}
                    {click === '/company-goal' && <Clone />}
                    {click === '/my-goal' && <Clone />}
                    {click === '/daily-task' && <Clone />}
                    {direct === '/direct-page' && <Direct />}
                </div>
            ...
            <div className={`addtaskcomponent`}>
                <Modal open={isModalOpen} onCancel={handleCancel}>
                    < AddTask handleCancel={handleCancel} />
                </Modal>
            </div>
